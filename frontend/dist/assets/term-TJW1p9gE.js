import{_ as f,c as e,a as n,b as a,d as p,r as s,p as N,q as g,F as m,u as v,o as i,x as C,J as D}from"./index-CRJSQdz7.js";const H={name:"Term",data(){return{activeSection:"section-1",currentUser:"Trần Tuấn Minh",currentDate:"2025-07-12 08:13:26",sections:[{id:"section-1",title:"1. Giới thiệu",content:`
          ...
          `},{id:"section-2",title:"2. Sử dụng dịch vụ",content:`
          ...
          `},{id:"section-3",title:"3. Chính sách bảo mật",content:`
          ...
          `},{id:"section-4",title:"4. Nội dung trong dịch vụ",content:`
          ...
          `},{id:"section-5",title:"5. Thay đổi và chấm dứt dịch vụ",content:`
          ...
          `},{id:"section-6",title:"6. Bảo đảm và tuyên bố từ chối trách nhiệm",content:`
          ...
          `},{id:"section-7",title:"7. Luật áp dụng",content:`
          ...
          `}]}},mounted(){this.sections.push({id:"owner-info",title:"Thông tin chủ sở hữu"}),window.addEventListener("scroll",this.handleScroll)},beforeDestroy(){window.removeEventListener("scroll",this.handleScroll)},methods:{scrollToSection(o){const t=document.getElementById(o);t&&(t.scrollIntoView({behavior:"smooth",block:"start"}),this.activeSection=o)},handleScroll(){const o=document.querySelectorAll(".section");let t=this.activeSection;o.forEach(l=>{const r=l.offsetTop,h=l.offsetHeight,d=window.scrollY;d>=r-200&&d<r+h-200&&(t=l.id)}),t!==this.activeSection&&(this.activeSection=t)}}},T={class:"terms-container"},G={class:"container-fluid mt-5"},x={class:"row"},B={class:"col-md-4 toc-column"},S={class:"col-md-8 content-column"},w={class:"card shadow-sm"},I={class:"card-body"},K={class:"text-muted text-center"},V={class:"terms-content"},q=["id"],M={key:0},O={key:1},U={class:"section-title"},L=["innerHTML"],R={class:"mt-4 text-center text-muted"};function E(o,t,l,r,h,d){const b=s("a-menu-item"),y=s("a-menu"),k=s("a-card"),_=s("a-affix"),u=s("a-divider");return i(),e("div",T,[n("div",G,[n("div",x,[n("div",B,[a(_,{"offset-top":20},{default:p(()=>[a(k,{title:"Mục lục",class:"toc-card"},{default:p(()=>[a(y,{mode:"inline",selectedKeys:[h.activeSection],style:{height:"calc(100vh - 150px)","overflow-y":"auto"}},{default:p(()=>[(i(!0),e(m,null,v(h.sections,c=>(i(),C(b,{key:c.id,onClick:P=>d.scrollToSection(c.id)},{default:p(()=>[D(g(c.title),1)]),_:2},1032,["onClick"]))),128))]),_:1},8,["selectedKeys"])]),_:1})]),_:1})]),n("div",S,[n("div",w,[n("div",I,[t[0]||(t[0]=n("h1",{class:"mb-4 text-center"},"Điều khoản dịch vụ",-1)),n("p",K,"Cập nhật lần cuối: "+g(h.currentDate),1),a(u),n("div",V,[(i(!0),e(m,null,v(h.sections,c=>(i(),e("div",{key:c.id,id:c.id,class:"mb-5 section"},[c.id==="owner-info"?(i(),e("div",M)):(i(),e("div",O,[n("h2",U,g(c.title),1),n("div",{innerHTML:c.content},null,8,L)]))],8,q))),128))]),a(u),t[1]||(t[1]=N('<div id="owner-info" class="mb-5 section" data-v-af9d136c><h2 class="section-title" data-v-af9d136c>Thông tin chủ sở hữu</h2><div class="owner-info" data-v-af9d136c><p data-v-af9d136c><strong data-v-af9d136c>Dự án thuộc về:</strong> Trần Tuấn Minh</p><p data-v-af9d136c><strong data-v-af9d136c>Địa chỉ:</strong> Không cho biết</p><p data-v-af9d136c><strong data-v-af9d136c>Email liên hệ:</strong> minhhblh31@gmail.com</p><p data-v-af9d136c><strong data-v-af9d136c>Số điện thoại:</strong> (+84) 369 525 ***</p><p data-v-af9d136c><strong data-v-af9d136c>Giấy phép kinh doanh:</strong> Số #191024 cấp ngày 19/11/2024</p></div></div>',1))])]),n("div",R,[n("p",null,"~~~"+g(h.currentUser)+"~~~",1),n("p",null,g(h.currentDate),1)])])])])])}const A=f(H,[["render",E],["__scopeId","data-v-af9d136c"]]);export{A as default};
